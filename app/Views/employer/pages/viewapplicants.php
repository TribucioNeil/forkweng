...
<div class="container-scroller">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                        <?php foreach ($jobseekerData as $appli): ?>
                                        <tr>
    ...
    <form action="<?= site_url('viewdetailsjobseekersemp')?>" method="post">
        <input type="hidden" name="jobApplyId" value="<?= $appli['id']?>">
        <button type="submit" style="border-radius: 5px; padding: 5px;" class="btn-success">View Details</button>
    </form>
</div>
