            ...
            <div class="row justify-content-center"><!-- Center the row -->
                <div class="col-lg-4 col-md-5 col-12">
                    <div class="p-4 bg-white rounded shadow-md mx-auto w-100" style="max-width: 400px;">
                        <form action="<?= site_url('jresendemail') ?>" method="post">
                            ...
                            <!-- <h6>An activation has been sent to:</h6>
                            <p><= $email ?></p>
                            <h6>Please click the button in the message to confirm your email address.</h6> -->
                            ...
                            <div class="col-12 text-center mt-3">
                                <span><span class="text-muted me-2 small"></span> <a href="jlogout" class="text-dark fw-semibold small">Back</a></span>
                            </div><!--end col-->
                        </form>
                    </div>
                </div><!--end col-->
