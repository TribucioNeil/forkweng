<?= $this->include('default/inc/signupheader')?>
    <body>        
                ...
                <div class="row justify-content-center"><!-- Center the row -->
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="p-4 bg-white rounded shadow-md mx-auto w-100" style="max-width: 400px;">
                            <form action="jsignupprocess" method="post">
                                ...
                                <h6 class="mb-3 text-uppercase fw-semibold text-center">Register your account</h6>
                                ...
                                <div class="col-12 text-center mt-3">
                                    <span><span class="text-muted small me-2">Already have an account ? </span> <a href="jlogin" class="text-dark fw-semibold small">Sign in</a></span>
                                </div><!--end col-->
                            </form>
                        </div>
                    </div><!--end col-->
        ...
        <!-- ENd Hero -->
<?= $this->include('default/inc/signupfooter')?>