        ...
        <div class="main-panel">
            ...
            <button >Edit Personal Information</button> 
                ...
                <form action="<?= site_url('generatePdf') ?>" method="post">
                 <span><button type="submit">PDF</button></span> 
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input class="form-control fw-bold text-uppercase" style="height: 3rem;" name="surName" value="<?php echo strtoupper($personalInfo['SurName']); ?>" placeholder="<?php echo strtoupper($personalInfo['SurName']); ?>">
